...
Este reto es una de las competencias de juego de la plataforma Kaggle, que tiene como objetivo predecir el precio de venta de una propiedad en dólares (SalePrice). Se evalúa el nivel de ajuste del modelo en base a la raíz del error cuadrático medio (RMSE). El enlace de la competencia es: https://www.kaggle.com/c/house-prices-advanced-regression-techniques/overview
